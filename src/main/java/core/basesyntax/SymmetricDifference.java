...
public class SymmetricDifference<T> {
    public Set<T> symmetricDifference(Set<? extends T> set1, Set<? extends T> set2) {
        Set<T> internalSet1 = new HashSet<>(set1);
        Set<T> internalSet2 = new HashSet<>(set2);
        internalSet1.removeAll(set2);
        internalSet2.removeAll(set1);
        internalSet1.addAll(internalSet2);
        return internalSet1;
    }
}
